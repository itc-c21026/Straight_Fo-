...
public class TrackScript1 : MonoBehaviour
{
    ...
    {
        // トラック(コスト5)の制御プログラム
        if (script.trackbl2_2 == true)
        {
            if (this.transform.position.x >= 0) script.trackbl2_3 = true;
            script.trackbl2_2 = false;
        }

        if (script.trackbl2_3 == true)
        {
